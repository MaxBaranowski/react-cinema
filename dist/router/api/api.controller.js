...
var _MovieAdditional = _interopRequireDefault(require("../../models/MovieAdditional"));
...
var API = function API() {
  ...
  _defineProperty(this, "getMovieCast",
  /*#__PURE__*/
  function () {
      ...
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _context6.prev = 0;
              _ref12 = Object.keys(req.body).length > 0 ? req.body : req.params, id = _ref12.id;
              _context6.next = 4;
              return new _MovieAdditional["default"]({
                movieID: id
              }).getCast().then(function (result) {
                res.json(result);
              })["catch"](function (err) {
                res.status(200).json([]); // there is no such movie
                // throw new Error(err);
